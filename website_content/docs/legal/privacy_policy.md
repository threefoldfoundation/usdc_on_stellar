...
description: Privacy Policy concerning USDC on Stellar
sidebar_position: 2
---

*This privacy policy will explain how USDC on Stellar Movement ("companies", "we", or "us") uses the personal data we collect from you when you use our websites, including the USDC on Stellar website.*

### What data do we collect? 

All websites using the USDC on Stellar Privacy Policy do not collect any data on a personal level by default. All data being processed is anonymized. When signing up for our newsletter we collect your: *email address*.
